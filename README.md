#AUTHOR >>Trefania <tarirotrefania@gmail.com>
...
```c
git clone https://github.com/Trefania/simple_shell
```
...
- Trefania - [@Trefania Vhareta](https://github.com/Trefania) 
- Geoffy1  - [@Geofrey Simiyu](https://github.com/Geoffy1)